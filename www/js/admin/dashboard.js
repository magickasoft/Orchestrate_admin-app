...
function AppRunner($rootScope, Restangular, $timeout, $window, $location, $cookies/*, $templateCache*/ ) {
    ...
    var ss = localStorage.getItem("selectedServer");
    if (ss !== undefined && ss !== "undefined" && ss !== "" && ss !== null && ss !== "null") {
        API_BASE = JSON.parse(ss).url + 'api/';
        API_STORAGE_ROOT = JSON.parse(ss).url;
